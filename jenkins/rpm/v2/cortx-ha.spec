...
ln -sf $HA_DIR/lib/event_analyzer_d $HA_DIR/bin/event_analyzer_d
ln -sf $HA_DIR/lib/event_analyzer_d /usr/bin/event_analyzer_d
ln -sf $HA_DIR/lib/event_analyzer_d /usr/local/bin/event_analyzer_d
exit 0
...
rm -f /usr/local/bin/event_analyzer_d 2> /dev/null;
rm -f /usr/bin/event_analyzer_d 2> /dev/null;
rm -f $HA_DIR/bin/event_analyzer_d 2> /dev/null;
exit 0
