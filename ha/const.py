...
CORTX_CLUSTER_NODE_ADD="/usr/bin/env python3 /home/708945/src/Repos/cortx-ha/ha/cli/cortxha.py cluster add node --nodeid <node> --username <user> --password <secret>"
