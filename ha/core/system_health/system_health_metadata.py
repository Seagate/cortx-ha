...
class SystemHealthComponents:
    ...
    _components = {const.COMPONENTS.SERVER_HARDWARE.value: {const.RESOURCE_LIST: ["node:fru", "node:sensor", "node:os", "node:interface"],
                                                            const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"server"+HA_DELIM+"$server_id"+HA_DELIM+"hw"+HA_DELIM+"$comp_type"+HA_DELIM+"$comp_id"+HA_DELIM+"health"},
                   const.COMPONENTS.SERVER_SERVICE.value: {const.RESOURCE_LIST: ["node:sw"],
                                                           const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"server"+HA_DELIM+"$server_id"+HA_DELIM+"service"+HA_DELIM+"$comp_type"+HA_DELIM+"$comp_id"+HA_DELIM+"health"},
                   const.COMPONENTS.SERVER.value: {const.RESOURCE_LIST: ["server"],
                                                   const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"server"+HA_DELIM+"$server_id"+HA_DELIM+"health"},
                   const.COMPONENTS.STORAGESET.value: {const.RESOURCE_LIST: ["storageset"],
                                                       const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"storageset"+HA_DELIM+"$storageset_id"+HA_DELIM+"health"},
                   const.COMPONENTS.STORAGE_COMPONENT.value: {const.RESOURCE_LIST: ["enclosure"],
                                                              const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"storage"+HA_DELIM+"$storage_id"+HA_DELIM+"hw"+HA_DELIM+"$comp_type"+HA_DELIM+"$comp_id"+HA_DELIM+"health"},
                   const.COMPONENTS.STORAGE.value: {const.RESOURCE_LIST: ["storage"],
                                                    const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"storage"+HA_DELIM+"$storage_id"+HA_DELIM+"health"},
                   const.COMPONENTS.NODE.value: {const.RESOURCE_LIST: ["node"],
                                                 const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"health"},
                   const.COMPONENTS.RACK.value: {const.RESOURCE_LIST: ["rack"],
                                                 const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"health"},
                   const.COMPONENTS.SITE.value: {const.RESOURCE_LIST: ["site"],
                                                 const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"health"},
                   const.COMPONENTS.CLUSTER.value: {const.RESOURCE_LIST: ["cluster"],
                                                    const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"health"},
                   const.COMPONENTS.AGG_SERVICE.value: {const.RESOURCE_LIST: [],
                                                        const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"service"+HA_DELIM+"$comp_type"+HA_DELIM+"$comp_id"+HA_DELIM+"aggregate"},
                   const.COMPONENTS.NODE_MAP.value: {const.RESOURCE_LIST: [],
                                                     const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"node_map"+HA_DELIM+"$node_id"},
                   const.COMPONENTS.CVG.value: {const.RESOURCE_LIST: ["cvg"],
                                                 const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"cvg"+HA_DELIM+"$cvg_id"+HA_DELIM+"health"},
                   const.COMPONENTS.DISK.value: {const.RESOURCE_LIST: ["disk"],
                                                 const.KEY: HA_DELIM+"cortx"+HA_DELIM+"ha"+HA_DELIM+"system"+HA_DELIM+"cluster"+HA_DELIM+"$cluster_id"+HA_DELIM+"site"+HA_DELIM+"$site_id"+HA_DELIM+"rack"+HA_DELIM+"$rack_id"+HA_DELIM+"node"+HA_DELIM+"$node_id"+HA_DELIM+"cvg"+HA_DELIM+"$cvg_id"+HA_DELIM+"disk"+HA_DELIM+"$disk_id"+HA_DELIM+"health"}}
